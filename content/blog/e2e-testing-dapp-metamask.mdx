...
description: "Run Playwright tests against a real MetaMask extension. Connect, sign, and reject flows covered in CI. No mocks, no manual clicks."
author: Chroma Team
date: 2025-03-04
---
...
Here’s how to get that with [Chroma](https://github.com/avalix-labs/chroma): Playwright tests that control MetaMask Flask, import an account, authorize connections, and confirm or reject transactions, all in code.
...
- **[MetaMask wallet guide](/docs/wallets/metamask)**: API reference and more examples.
- **[Testing dApps](/docs/guides/testing-dapps)**: Page Object Model, test data, and waiting for blockchain state.
- **[Multi-chain guide](/docs/guides/multi-chain)**: Run MetaMask alongside other Chroma-supported wallets in the same project.
